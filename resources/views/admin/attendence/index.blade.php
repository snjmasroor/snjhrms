...
<div class="main px-lg-4 px-md-4"> 
    ...
    @php
        $employee = $records->first()->user; // grouped by employee_id
    @endphp
    <tr>
        <td>
    ...
    @php
        ...
        if ($dayName === 'Sunday') {
            // Sunday off
            $icon = 'icofont-calendar text-danger'; 
            ...
            $tooltip = $date->toDateString() . ' - Absent';
        }
    @endphp

    <td data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $tooltip }}">
        <i class="{{ $icon }}"></i>
    </td>
@endfor
    </tr>
