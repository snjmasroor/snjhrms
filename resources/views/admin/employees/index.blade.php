                                ...
                                <div class="card-body d-flex">
                                    <div class="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                                        <img src="{{ $user->profile_picture 
                                            ? asset('storage/users/profile_pictures/'.$user->id.'/'.$user->profile_picture) 
                                            : asset('assets/images/lg/avatar3.jpg') }}" 
                                            alt="{{ $user->name }}" 
                                        ...
                                        <div class="about-info d-flex align-items-center mt-3 justify-content-center">
                                            <div class="followers me-2">
                                                ...
                                                <span>{{--$user->tasks_count ?? 0 --}} 0</span>
                                            </div>
                                            <div class="star me-2">
                                            ...
                                            <div class="own-video">
                                                ...
                                                <span>{{-- $user->projects_count ?? 0 --}}0</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                        ...
                                        {{ $user->designation ?? ($user->role->name ?? 'Employee') }}
                                        </span>
                                        <div class="video-setting-icon mt-3 pt-3 border-top">
                                            <p>{{ $user->description ?? 'No description available.' }}</p>
                                        </div>
                                        <a href="{{--route('tasks.create', $user->id) --}}" class="btn btn-dark btn-sm mt-1">
